    ...
    >
      <div className="flex-1 p-6">
        ...
        <div className="grid grid-cols-2 gap-6 mb-8">
          <div>
            ...
            <div className="bg-slate-800 rounded-2xl p-4" role="group" aria-labelledby="weight-label">
              ...
              <div className="flex justify-center gap-4 mt-4">
                <button
                  ...
                  className="bg-slate-700 hover:bg-slate-600 text-white p-3 rounded-xl transition-colors focus:outline-none focus:ring-2 focus:ring-orange-400"
          ...
          <div>
            ...
            <div className="bg-slate-800 rounded-2xl p-4" role="group" aria-labelledby="reps-label">
              <div className="text-center">
        ...
        {techMode && (
          <div className="mb-8">
            ...
            <div className="flex justify-between bg-slate-800 rounded-2xl p-3" role="radiogroup" aria-labelledby="rpe-label">
              {[6, 7, 8, 9, 10].map((value) => (
                <button
                  ...
                  className={`w-12 h-12 rounded-xl font-bold transition-all focus:outline-none focus:ring-2 focus:ring-orange-400 ${
                    rpe === value
        ...
        <button
          className="w-full bg-slate-800 hover:bg-slate-700 text-gray-300 py-4 rounded-2xl flex items-center justify-center gap-3 mb-4 transition-colors focus:outline-none focus:ring-2 focus:ring-orange-400"
      ...
      <div className="p-6 bg-slate-900/80 backdrop-blur-lg border-t border-slate-800">
        <button
          ...
          className="w-full bg-gradient-to-r from-orange-500 to-red-500 text-white font-bold py-5 rounded-2xl text-lg hover:scale-[1.02] transition-transform shadow-lg shadow-orange-500/30 mb-3 focus:outline-none focus:ring-2 focus:ring-orange-400 focus:ring-offset-2 focus:ring-offset-slate-900"
        >
          ✓ LOG SET
        </button>
        <button
