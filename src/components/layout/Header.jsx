      ...
      <div className="flex items-center justify-between p-4">
        {onBack ? (
          ...
          <div>
            ...
            <p className="text-orange-400 font-bold text-sm tracking-wider">{title || 'STS M0TIV8R'}</p>
          </div>
        )}
        ...
        <div className="flex items-center gap-3">
          ...
          {userAvatar && (
            <div
              className="w-10 h-10 bg-gradient-to-br from-orange-500 to-red-500 rounded-full flex items-center justify-center text-white font-bold"
